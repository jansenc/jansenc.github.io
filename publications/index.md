...
<div class="pub journal">
  <div class="pub-left">
    ...
    <details><summary>Abstract</summary>
      Thomas Augustin (1965–2026), professor at the Institute of Statistics at Ludwig-Maximilians-Universität München, passed away unexpectedly on 10 January 2026. This obituary celebrates Thomas as a person and an academic. It also attempts to pay tribute to his immensely rich scientific legacy covering a wide range of areas within statistics and imprecise probability theory. Although the list of authors who contributed to this article is by no means short, it still represents only a modest subset of the people who proudly referred to Thomas as their supervisor, collaborator, colleague and, most importantly, friend. This means that our article is bound to remain incomplete in many respects: it is simply not possible to capture such a rich academic life in a single article, especially when so many different perspectives would deserve to be heard. Nevertheless, we believe our article highlights a nice selection of aspects of Thomas as a person and an academic, capturing some of his most important articles, scientific activities, and visionary ideas.
    </details>
  </div>
